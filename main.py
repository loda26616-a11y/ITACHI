...
DM_LINK = "https://t.me/ITACHI_HACK_MANAGERR?text=HELLO%20ADNAN%20BHAI%20MUJHE%20LOSS%20RECOVER%20KRWANA%20HAI"
    ...
    for attempt in range(3):
        try:
            ...
            if APK_CACHE:
                ...
                apk_file.name = "𝐈𝐓𝐀𝐂𝐇𝐈_𝐈𝐍𝐉𝐄𝐂𝐓𝐎𝐑_𝐇𝐀𝐂𝐊_1_0_jaiwin (1).apk"
                await context.bot.send_document(
                    chat_id=user.id,
                    document=apk_file,
                    filename="𝐈𝐓𝐀𝐂𝐇𝐈_𝐈𝐍𝐉𝐄𝐂𝐓𝐎𝐑_𝐇𝐀𝐂𝐊_1_0_jaiwin (1).apk",
                    caption=(
                        "✅ 100% NUMBER HACK 💥\n\n"
                        "( ONLY FOR PREMIUM USERS ⚡️ )\n"
                        "( 100% LOSS RECOVER GUARANTEE ⚡️ )\n\n"
                        "HOW TO USE - https://t.me/HOW_TO_USE_ITACHI_HACK/5\n"
                        "FOR HELP @ITACHI_HACK_MANAGER"
                    ),
                    reply_markup=VIP_BUTTON
                )
